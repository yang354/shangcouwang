...
public class CrowdAccessFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        // 3.获取servletPath值
        // 例如访问http://localhost/bootstrap/css/bootstrap.min.css
        // 取 /bootstrap/css/bootstrap.min.css   /project/get/project/detail/{projectId}
        ...
        if (servletPath.contains("/project/get/project/detail")){
            return false;
        }
